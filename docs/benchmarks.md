...
**96** automated tests on this revision: identity (move, SSH ≡ HTTPS, two clones, fork, worktree, monorepo), leftover import, search filters and title ranking, plugin schemas, install / doctor / uninstall, heartbeat, MCP tools.
